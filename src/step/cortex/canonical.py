...
def build_canonical_circuit(
    ...
    *,
    ...
    circuit.connect(s2.l5, s1.l23, ConnectionRole.APICAL, thalamic_gate=gate())
    circuit.connect(s2.l5, s1.l5, ConnectionRole.APICAL, thalamic_gate=gate())
    circuit.connect(s3.l5, s2.l23, ConnectionRole.APICAL, thalamic_gate=gate())
    circuit.connect(s3.l5, s2.l5, ConnectionRole.APICAL, thalamic_gate=gate())
    ...
    circuit.connect(s1.l5, m1.l5, ConnectionRole.APICAL, thalamic_gate=gate())
    circuit.connect(m1.l5, s1.l23, ConnectionRole.APICAL, thalamic_gate=gate())
    circuit.connect(m1.l5, s1.l5, ConnectionRole.APICAL, thalamic_gate=gate())
